...
long a = 1, b, c = 5000000, d=10000000;
double start, finish;
bool check;
int main (){
...
//	nums6.displayGroupOfNumbers();
	...
	cout << "Start: " << start << " Finish: " << finish << " Timing: " << finish - start << endl;
		...
		GroupOfNumbers nums8(input1, input2, input3);
//	cout << "----- _group -----" << endl;
//	nums6.displayGroupOfNumbers();
	cout << "----- Sort Select -----" << endl;
	start = user_time() + system_time();
	check = nums8.sort_select(c,b);	
	finish = user_time() + system_time();
	cout << "return: " << check << " k: " << a << " kth_smallest: " << b << endl;
	cout << "Start: " << start << " Finish: " << finish << " Timing: " << finish - start << endl;
	
		GroupOfNumbers nums9(input1, input2, input3);
//	cout << "----- _group -----" << endl;
//	nums6.displayGroupOfNumbers();
	cout << "----- Sort Select -----" << endl;
	start = user_time() + system_time();
	check = nums9.sort_select(d,b);	
	finish = user_time() + system_time();
	cout << "return: " << check << " k: " << a << " kth_smallest: " << b << endl;
	cout << "Start: " << start << " Finish: " << finish << " Timing: " << finish - start << endl;
