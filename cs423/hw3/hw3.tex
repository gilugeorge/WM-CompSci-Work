...
\begin{enumerate}
 ...
 \item (10 points) Exercise 1.21(b) on page 86. (Remove the states in the order of 1, 2, and 3.)
  \begin{description}
    \item a) \includegraphics[scale=.4] {fig2.pdf}
    \item b) \includegraphics[scale=.4] {fig3.pdf}
    \item c) \includegraphics[scale=.4] {fig4.pdf}
    \item d) \includegraphics[scale=.4] {fig5.pdf}
  \end{description}
